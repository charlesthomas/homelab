...
# 80-home-assistant/automations-yaml.partial.yaml
...
yq ".data.\"automations.yaml\" = load_str(\"80-home-assistant/.list.yaml\")" 80-home-assistant/automations-yaml.partial.yaml > 80-home-assistant/automations-yaml.yaml
